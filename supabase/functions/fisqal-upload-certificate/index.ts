// =============================================================================
// fisqal-upload-certificate — CASCA DE COMPATIBILIDADE (DEPRECIADA).
// =============================================================================
// ⚠️ ESTA ROTA SAI NO RELEASE SEGUINTE. Use `nfse-upload-certificate`.
//
...
//
// Remoção: depois de 1 release com `nfse-upload-certificate` no ar, apagar esta pasta e a
