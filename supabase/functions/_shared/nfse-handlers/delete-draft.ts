// =============================================================================
// Handler de EXCLUSÃO de rascunho (rotas: nfse-delete-draft / fisqal-delete-nfse-draft).
// =============================================================================
...
export async function handleNfseDeleteDraft(req: Request): Promise<Response> {
  ...
  try {
    ...
    if (deleteErr) {
      console.error("[nfse-delete-draft] delete error", {
    ...
    console.error("[nfse-delete-draft] unexpected error", {
