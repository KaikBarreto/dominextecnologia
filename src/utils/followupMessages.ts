...
export const FOLLOWUP_MESSAGES: Record<number, string> = {
  ...
  2: "Oi, tudo bem? Voltando de onde a gente parou 🙂\n\nUma coisa que costuma chamar atenção na *Dominex*: o técnico abre a OS no celular, preenche o checklist, anexa as fotos e colhe a assinatura do cliente na hora — tudo no celular, em campo, e o relatório sai prontinho.\n\nQuer que eu te mostre como ficaria na sua operação?",
