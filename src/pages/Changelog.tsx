    ...
    changes: [
      {
        ...
        description: 'Agora o documento do orçamento e da proposta mostra também o CNPJ e o endereço completo do cliente, além do nome, telefone e e-mail, tanto na visualização e no PDF dentro do sistema quanto no link enviado ao cliente. Assim o documento fica mais formal e completo, do mesmo jeito que já exibe os dados da sua empresa. Quando o cliente ainda não tem esses dados cadastrados, o documento simplesmente mostra o que estiver disponível, sem nada em branco.',
        category: 'melhoria',
      },
    ],
  },
    ...
    changes: [
      {
        ...
        description: 'Quando o técnico anexa um vídeo na ordem de serviço, ele agora aparece pronto para assistir no relatório online, tanto para você quanto para o seu cliente pelo link, no tamanho e na proporção em que foi gravado (vídeo em pé fica em pé, sem cortes nem barras pretas). Antes, no lugar do vídeo aparecia só um aviso de texto. No PDF baixado, o vídeo continua indicado como disponível no relatório online, já que arquivos de vídeo não rodam dentro de um PDF.',
        category: 'correcao',
      },
    ],
  },
