...
import { FileText, Plus, Search, Calendar, DollarSign, CheckCircle, XCircle, Edit, Trash2, Pause, Play, ClipboardList, CalendarClock, ExternalLink } from 'lucide-react';
...
export default function PMOC() {
  ...
  // Generate timeline for next 12 occurrences from active plans
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Dialogs */}
      <PmocPlanFormDialog open={planDialogOpen} onOpenChange={o => { setPlanDialogOpen(o); if (!o) setEditingPlan(null); }} plan={editingPlan} />
      <PmocContractFormDialog open={contractDialogOpen} onOpenChange={o => { setContractDialogOpen(o); if (!o) setEditingContract(null); }} contract={editingContract} />
    </div>
  );
}
