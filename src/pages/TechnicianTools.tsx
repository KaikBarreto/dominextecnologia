...
import { Wrench, Thermometer, ArrowLeftRight, Boxes, Zap, Home } from 'lucide-react';
...
type ToolTab = 'inicio' | 'equipamentos' | 'carga-termica' | 'conversao' | 'calculo-capacitor';
      ...
      {activeTab !== 'inicio' && (
        <div className="lg:hidden">
          <MobilePillTabs
            ...
            activeTab={activeTab}
            onTabChange={(v) => setActiveTab(v as ToolTab)}
          />
        </div>
      )}
