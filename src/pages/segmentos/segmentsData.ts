...
const tiAssistencia: SegmentData = {
  slug: 'sistema-para-assistencia-tecnica',
  accentColor: '#6d28d9',
  navLabel: 'Assistência Técnica (TI)',
  icon: Laptop,
  metaTitle:
  ...
  features: [
    ...
    },
    {
      ...
      desc: 'Para lojas com técnico externo: veja onde está a equipe e valide o check-in no endereço do cliente.',
    },
    {
      icon: BarChart3,
      title: 'Indicadores da operação',
...
export const SEGMENTS: Record<string, SegmentData> = {
  ...
  [tiAssistencia.slug]: tiAssistencia,
};
...
export const SEGMENT_NAV_LINKS: SegmentNavLink[] = [
  ...
  { label: 'Assistência Técnica (TI)', slug: 'sistema-para-assistencia-tecnica', icon: Laptop },
];
