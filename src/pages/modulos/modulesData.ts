...
/**
 * Catálogo de páginas de MÓDULO (aba "Soluções" da landing — estilo Auvo:
 * "Auvo PMOC", "Auvo Financeiro"...). Arquitetura paralela à de segmentos
 * (src/pages/segmentos), data-driven, ZERO conteúdo hard-coded no componente.
 *
 * COMO ADICIONAR UM MÓDULO NOVO:
 *  1. Copie um objeto `ModuleData` abaixo e troque TODO o vocabulário
 *     (hero/dores/deep-dives/features/FAQ específicos do módulo).
 *  2. Defina `slug` (sem barra) e um H1 keyword-rico contendo a keyword de busca.
 ...
 *  - Nota fiscal é sempre NFS-e (serviço), NUNCA NF-e.
 */
...
export interface ModuleData {
  /** Slug da rota, ex: 'sistema-pmoc' (sem barra inicial). */
  slug: string;
  /** Rótulo curto do módulo, usado no dropdown "Soluções" do navbar. */
  navLabel: string;
  /** Ícone do módulo. */
  icon: LucideIcon;
  /** <title> da aba — keyword-rico. */
  metaTitle: string;
  /** <meta name="description"> — keyword-rico. */
  metaDescription: string;

  hero: {
    eyebrow: string;
    /** H1 — DEVE conter a keyword principal de busca do módulo. */
    h1: string;
  ...
  testimonials: ModuleTestimonial[];
...
/* ================================================================== */
/* 1. Ordem de Serviço Digital → /os-digital                          */
/* ================================================================== */

const osDigital: ModuleData = {
  slug: 'os-digital',
  navLabel: 'Ordem de Serviço Digital',
  icon: ClipboardList,
  metaTitle:
    'Sistema de ordem de serviço digital para equipes de campo | Dominex',
  metaDescription:
...
const pmoc: ModuleData = {
  slug: 'sistema-pmoc',
  navLabel: 'PMOC',
  icon: ShieldCheck,
  metaTitle:
    'Software de PMOC para climatização e refrigeração (Lei 13.589/2018) | Dominex',
  metaDescription:
...
const crm: ModuleData = {
  // Rota pública /sistema-crm (o path /crm já é a tela autenticada do CRM).
  slug: 'sistema-crm',
  navLabel: 'CRM & Vendas',
  icon: Users,
  metaTitle:
    'CRM para empresas de serviço e manutenção | Dominex',
  metaDescription:
...
const financeiro: ModuleData = {
  slug: 'controle-financeiro',
  navLabel: 'Financeiro',
  icon: Wallet,
  metaTitle:
    'Controle financeiro para empresas de serviço | Dominex',
  metaDescription:
...
/* ================================================================== */
/* 5. Ponto & Folha (RH) → /ponto-e-folha                            */
/* ================================================================== */

const pontoFolha: ModuleData = {
  slug: 'ponto-e-folha',
  navLabel: 'Ponto & Folha (RH)',
  icon: Clock,
  metaTitle:
    'Ponto eletrônico e folha de pagamento para equipes de campo | Dominex',
  metaDescription:
...
/* ================================================================== */
/* 6. NFS-e → /emissao-de-nfse                                       */
/* ================================================================== */

const nfse: ModuleData = {
  slug: 'emissao-de-nfse',
  navLabel: 'NFS-e',
  icon: FileText,
  metaTitle:
    'Emissão de NFS-e para empresas de serviço | Dominex',
  metaDescription:
...
/* ================================================================== */
/* 7. Portal do Cliente → /portal-do-cliente                         */
/* ================================================================== */

const portalCliente: ModuleData = {
  slug: 'portal-do-cliente',
  navLabel: 'Portal do Cliente',
  icon: UserCircle,
  metaTitle:
    'Portal do cliente para empresas de serviço | Dominex',
  metaDescription:
...
const estoque: ModuleData = {
  slug: 'controle-de-estoque',
  navLabel: 'Estoque',
  icon: Boxes,
  metaTitle:
    'Controle de estoque para equipes de campo | Dominex',
  metaDescription:
...
/* ================================================================== */
/* 9. Orçamentos & Contratos → /orcamentos-e-contratos               */
/* ================================================================== */

const orcamentosContratos: ModuleData = {
  slug: 'orcamentos-e-contratos',
  navLabel: 'Orçamentos & Contratos',
  icon: FileSignature,
  metaTitle:
    'Orçamentos e contratos para empresas de serviço | Dominex',
  metaDescription:
...
/* ================================================================== */
/* 10. Rastreamento & Agenda → /rastreamento-de-equipes              */
/* ================================================================== */

const rastreamentoAgenda: ModuleData = {
  slug: 'rastreamento-de-equipes',
  navLabel: 'Rastreamento & Agenda',
  icon: MapPin,
  metaTitle:
    'Rastreamento de equipes e agenda para serviços de campo | Dominex',
  metaDescription:
...
/* ================================================================== */
/* 11. Área do Técnico™ → /area-do-tecnico                           */
/* ================================================================== */

const areaTecnico: ModuleData = {
  slug: 'area-do-tecnico',
  navLabel: 'Área do Técnico™',
  icon: Wrench,
  metaTitle:
    'Área do Técnico™: o app de campo da sua equipe | Dominex',
  metaDescription:
...
export const MODULES: Record<string, ModuleData> = {
  ...
  'ponto-e-folha': pontoFolha,
  'emissao-de-nfse': nfse,
  'portal-do-cliente': portalCliente,
  'controle-de-estoque': estoque,
  'orcamentos-e-contratos': orcamentosContratos,
  'rastreamento-de-equipes': rastreamentoAgenda,
  'area-do-tecnico': areaTecnico,
};

/**
 * Links de navegação do dropdown "Soluções" do navbar. O dev do menu lê deste
 * array (mesma estratégia de SEGMENT_NAV_LINKS), mantendo a ordem dos módulos.
 */
...
export const MODULE_NAV_LINKS: ModuleNavLink[] = [
  { label: 'Ordem de Serviço Digital', slug: 'os-digital', icon: ClipboardList },
  { label: 'PMOC', slug: 'sistema-pmoc', icon: ShieldCheck },
  { label: 'CRM & Vendas', slug: 'sistema-crm', icon: Users },
  { label: 'Financeiro', slug: 'controle-financeiro', icon: Wallet },
  { label: 'Ponto & Folha (RH)', slug: 'ponto-e-folha', icon: Clock },
  { label: 'NFS-e', slug: 'emissao-de-nfse', icon: FileText },
  { label: 'Portal do Cliente', slug: 'portal-do-cliente', icon: UserCircle },
  { label: 'Estoque', slug: 'controle-de-estoque', icon: Boxes },
  { label: 'Orçamentos & Contratos', slug: 'orcamentos-e-contratos', icon: FileSignature },
  { label: 'Rastreamento & Agenda', slug: 'rastreamento-de-equipes', icon: MapPin },
  { label: 'Área do Técnico™', slug: 'area-do-tecnico', icon: Wrench },
];
