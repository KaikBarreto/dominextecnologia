...
const en: ModuleContentMap = {
  ...
  // ────────────────────────────────────────────────────────────────────────
  // 2. PMOC (Brazilian mandatory HVAC maintenance plan)
  // ────────────────────────────────────────────────────────────────────────
  'sistema-pmoc': {
    slug: 'hvac-maintenance-plan-software',
    metaTitle: 'HVAC Preventive Maintenance Plan Software (Brazil PMOC, Law 13.589/2018) | Dominex',
    metaDescription:
      'Software for Brazil\'s mandatory HVAC maintenance plan (PMOC): a maintenance plan per unit of equipment, automatic recurring visits, a checklist per machine, an audit-ready PMOC report, and a QR code on each unit, under Federal Law 13.589/2018. Free 14-day trial, no credit card.',
    hero: {
      eyebrow: 'Automatic PMOC',
      h1: 'HVAC preventive maintenance plan software',
      h1Highlight: 'HVAC maintenance plan',
      subtitle:
        'Stop building your maintenance plan in a side spreadsheet. Dominex generates Brazil\'s mandatory HVAC maintenance plan (PMOC) per unit of equipment under Federal Law 13.589/2018, schedules the visits on its own, and delivers the report ready for inspection.',
    },
    metrics: [
      { value: 'Law 13.589', label: 'PMOC compliant with Brazilian federal law' },
    ...
    painsSubheading: 'Where the side spreadsheet fails, Dominex keeps you compliant',
    pains: [
      {
        pain: 'A maintenance plan built by hand, with no trail and out of compliance',
        solution:
          'The system builds the Maintenance, Operation, and Control Plan (PMOC) from the equipment on the contract, under Law 13.589/2018, with the responsible technician, the visit cycle, and a checklist per machine.',
      },
      {
        pain: 'Missed this month\'s visit and the schedule fell apart',
        solution:
          'PMOC visits are generated automatically on the right cycle (monthly, quarterly, semiannual). Each one is born with the maintenance routine for that phase of the plan.',
      },
      {
        pain: 'An inspector asked for the PMOC and you had no document ready',
        solution:
          'The PMOC report and the compliance record come out as a branded PDF, with what was done on each visit and the responsible technician\'s signature. You present it on the spot.',
      },
      {
    ...
    deepDives: [
      {
        icon: RefreshCw,
        title: 'Automatic PMOC compliant with Law 13.589/2018',
        body: 'The Maintenance, Operation, and Control Plan (PMOC) required by Brazilian law for shared-use air conditioning systems is built from the equipment on the contract. Dominex spreads the visits across the cycle, builds each visit\'s checklist by the phase of the plan, records the responsible technician, and generates the PMOC record and compliance report ready to present at an inspection, with no side spreadsheet.',
        image: {
      ...
      },
      {
        ...
        body: 'Each machine (split, multi-split, VRF, chiller, fan coil, self-contained) has its own maintenance schedule, with the right routine for each visit of the 12-month cycle. Inspectors and customers see exactly what was done on each unit, when, and by whom.',
        image: {
      ...
      },
      {
        ...
        body: 'Stick a QR code on the machine: the technician points the camera and lands straight on that unit\'s record, with its history and the next PMOC visit. Recurring visits are generated by the system at the right interval, with the checklist ready, so preventive maintenance never depends on anyone\'s memory.',
        image: {
    ...
    featuresHeading: 'A complete PMOC, from generation to inspection',
    featuresSubheading: 'Compliance with Law 13.589/2018 without manual work',
    features: [
      { icon: RefreshCw, title: 'Automatic PMOC generation', desc: 'The plan is built from the equipment on the contract, with the visit cycle and responsible technician.' },
      ...
      { icon: Calendar, title: 'Recurring visits', desc: 'The system schedules PMOC visits at the right interval, with no need to remember.' },
      { icon: CheckSquare, title: 'Checklist by phase', desc: 'Each visit of the 12-month cycle carries the matching maintenance routine.' },
      { icon: FileText, title: 'Compliance report', desc: 'The PMOC record and PDF report ready to present to an inspector.' },
      ...
      { icon: FileSignature, title: 'Responsible technician signature', desc: 'The responsible technician signs the PMOC documents, carrying your company\'s identity.' },
      { icon: ShieldCheck, title: 'Legal compliance', desc: 'Everything under Federal Law 13.589/2018 for shared-use air conditioning.' },
    ],
    testimonialsHeading: 'The PMOC stopped being a nightmare',
    testimonials: [
      { quote: 'The PMOC was spreadsheet on top of spreadsheet. Now the system builds the schedule and the report on its own. I presented it to the inspector without breaking a sweat.', name: 'Roberta S.', role: 'Responsible Technician', company: 'building HVAC' },
    ...
    faq: [
      { q: 'What is the PMOC and why is it mandatory?', a: 'The PMOC (Maintenance, Operation, and Control Plan) is Brazil\'s mandatory HVAC maintenance plan, required by Federal Law 13.589/2018 for shared-use air conditioning systems. It documents preventive maintenance, the responsible technician, and each unit\'s history, and it must be presented during an inspection.' },
      { q: 'Does Dominex generate the PMOC automatically?', a: 'Yes. The system builds the PMOC from the equipment on the contract, spreads the visits across the cycle, builds each visit\'s checklist, and generates the record and compliance report ready for inspection, with no side spreadsheet.' },
      ...
      { q: 'Are PMOC visits scheduled on their own?', a: 'Yes. Recurring visits are generated by the system at the right interval (monthly, quarterly, semiannual), with the phase checklist ready. Preventive maintenance does not depend on the team\'s memory.' },
      { q: 'Is there a QR code on the equipment?', a: 'Yes. You stick a QR code on the machine and the technician, on scanning it, lands straight on that unit\'s record, with its history and the next PMOC visit.' },
      { q: 'Does the PMOC report come out with my branding?', a: 'Yes. The PMOC record and compliance report come out as a PDF with your logo and colors, with the responsible technician\'s signature, ready to hand to the customer and the inspector.' },
      ...
      { q: 'How do I get started? Do I need a credit card?', a: 'Just create an account and use it free for 14 days, no credit card. You register the equipment, set up the contract, and the PMOC is generated automatically.' },
    ],
    finalCta: {
      title: 'Generate the PMOC with no side spreadsheet',
      subtitle: 'Free for 14 days, no credit card. Register the equipment and have the PMOC ready for inspection.',
    },
  },
  ...
  'ponto-e-folha': {
    ...
    metaDescription:
      'Time tracking and payroll for field teams: clock in with a selfie and geolocation, an hours bank, payroll, advances, and employee management, all in one place. Free 14-day trial, no credit card.',
    hero: {
      eyebrow: 'Time Tracking & Payroll (HR)',
      h1: 'Time tracking and payroll for field teams',
      h1Highlight: 'Time tracking and payroll',
      subtitle:
        'Your team starts the day at the customer, not the office, so a paper time sheet does not cut it. Dominex clocks time with a selfie and location, calculates the hours bank, and closes payroll with advances deducted.',
    },
    metrics: [
      { value: 'Selfie + GPS', label: 'time clocked from wherever the technician is' },
      { value: 'Hours bank', label: 'overtime and absences calculated on their own' },
    ...
    pains: [
      ...
      {
        pain: 'The hours bank calculated by hand, always with errors',
        solution:
          'The system calculates hours worked, overtime, and absences from the clock-ins. The hours bank closes on its own, with no spreadsheet.',
      },
      {
    ...
    deepDives: [
      ...
      {
        icon: Clock,
        title: 'The hours bank calculated on its own',
        body: 'From the clock-ins, the system calculates hours worked, overtime, and absences, keeping the hours bank up to date. At the end of the month you have each employee\'s balance ready, without adding anything up by hand or fighting a spreadsheet.',
        image: {
      ...
      },
      {
        ...
        body: 'Payroll close consolidates salary, the hours bank, and the advances the employee took during the month, deducting them automatically from the net amount. The pay slip and the advance receipt come out ready, and the employee statement shows each entry in and out with the right sign.',
        image: {
    ...
    features: [
      ...
      { icon: Clock, title: 'Hours bank', desc: 'Overtime and absences calculated from the clock-ins, with no spreadsheet.' },
    ...
    testimonials: [
      ...
      { quote: 'The hours bank was a monthly headache. Now it closes on its own from the clock-ins.', name: 'Aline R.', role: 'HR', company: 'building maintenance' },
    ...
    faq: [
      ...
      { q: 'Is the hours bank calculated automatically?', a: 'Yes. From the clock-ins, the system calculates hours worked, overtime, and absences, keeping the hours bank up to date with no spreadsheet.' },
      { q: 'Can I close payroll in the system?', a: 'Yes. The close consolidates salary, the hours bank, and advances, deducting the advances automatically. The pay slip comes out ready.' },
  ...
  // ────────────────────────────────────────────────────────────────────────
  // 6. NFS-e (Brazilian electronic service invoice)
  // ────────────────────────────────────────────────────────────────────────
  'emissao-de-nfse': {
    slug: 'service-invoice-software',
    metaTitle: 'Electronic Service Invoice (NFS-e) Software for Service Companies | Dominex',
    metaDescription:
      'Issue Brazil\'s electronic service invoice (NFS-e) for service companies: issue the service invoice per customer, with municipal compliance, straight from the platform. No separate tax software. Free 14-day trial, no credit card.',
    hero: {
      eyebrow: 'Service Invoice (NFS-e)',
      h1: 'Electronic service invoice software for service companies',
      h1Highlight: 'service invoice',
      subtitle:
        'You did the job and still have to open another system to issue the invoice? Dominex issues the electronic service invoice (NFS-e) per customer, with your city\'s compliance, without leaving the platform where you already work.',
    },
    metrics: [
      { value: 'NFS-e', label: 'the service invoice issued on the platform' },
      { value: 'Per customer', label: 'issuance tied to the customer record' },
      { value: 'Municipal', label: 'compliant with the city hall of your municipality' },
      { value: '4.9/5', label: 'satisfaction among the companies that use it' },
    ],
    ...
    pains: [
      {
        ...
        solution:
          'The NFS-e is issued inside Dominex, per customer, without opening a separate issuer or retyping data. Less screen switching, fewer errors.',
      },
      {
      ...
      {
        pain: 'Unsure whether your city accepts electronic issuance',
        solution:
          'The system checks your municipality\'s coverage before issuing, respecting the city hall\'s rules. You know whether you can issue there.',
      },
      {
        pain: 'Invoice issued and lost, with no control over what has been billed',
        solution:
          'The NFS-e invoices are recorded and organized by customer, with what has already been issued. You track billing without digging through email.',
      },
    ],
    deepDives: [
      {
        icon: FileText,
        title: 'The NFS-e issued without leaving the platform',
        body: 'The NFS-e (electronic service invoice) is issued from inside Dominex, on the same platform where you manage customers and services. You select the customer, check the data already in the record, and issue, with no standalone issuer, no other login, and nothing retyped.',
        image: {
      ...
      {
        icon: Building2,
        title: 'Municipal compliance city by city',
        body: 'In Brazil the service tax (ISS) is municipal and each city hall has its own rules. Dominex checks your municipality\'s coverage before issuing, respecting the city\'s standard. Where issuance is supported, you issue the NFS-e with peace of mind, knowing the invoice meets the city hall\'s requirements.',
        image: {
          src: '/modulos/emissao-de-nfse/2.webp',
          alt: 'Professional reviewing tax documents and forms on a wooden desk',
        },
      },
      {
        icon: Receipt,
        title: 'Issuance per customer, with an organized history',
        body: 'Each NFS-e is issued from the customer record and stays in the history, organized by who was billed. You track what has already been issued, avoid duplicate invoices, and keep control of your billing without relying on a spreadsheet or your inbox.',
        image: {
    ...
    featuresSubheading: 'The NFS-e where you already manage the operation',
    features: [
      { icon: FileText, title: 'NFS-e issuance', desc: 'Issue the service invoice straight on the platform, with no standalone issuer.' },
      { icon: UserCircle, title: 'Issuance per customer', desc: 'The invoice pulls data from the customer record you already have.' },
      { icon: Building2, title: 'Municipal compliance', desc: 'The system respects your city\'s rules when issuing.' },
      { icon: CheckSquare, title: 'Coverage check', desc: 'Before issuing, the system checks whether the municipality is supported.' },
      { icon: Receipt, title: 'History per customer', desc: 'Track the NFS-e issued, organized by who was billed.' },
      { icon: ShieldCheck, title: 'National standard', desc: 'Adherence to the standard required for service invoices, per municipality.' },
      { icon: BarChart3, title: 'Billing control', desc: 'See what has already been issued and keep billing under control.' },
      { icon: FileCheck2, title: 'Ready document', desc: 'The issued NFS-e is available to send to the customer.' },
    ],
    ...
    testimonials: [
      ...
      { quote: 'I stopped retyping customer data just for the invoice. I select the customer and issue the NFS-e.', name: 'Fábio M.', role: 'Administrator', company: 'maintenance and installation' },
      { quote: 'Knowing whether my city accepts issuance before I issue saves headaches. The system checks it for me.', name: 'Bruno S.', role: 'Owner', company: 'field services' },
    ],
    faq: [
      { q: 'What is the NFS-e?', a: 'The NFS-e is Brazil\'s electronic service invoice, the tax document for service providers (whose tax, the ISS, is municipal). It is different from the NF-e, which is for the sale of products. Dominex issues the NFS-e, aimed at service companies.' },
      { q: 'Do I need another system to issue the invoice?', a: 'No. The NFS-e is issued from inside Dominex, per customer, without opening a standalone issuer or using another login. You select the customer and issue on the same platform where you already work.' },
      { q: 'Does issuance respect my municipality\'s rules?', a: 'Yes. The ISS is municipal and Dominex checks your municipality\'s coverage before issuing, respecting the city hall\'s standard. Where issuance is supported, the invoice comes out compliant with the city\'s requirements.' },
      ...
      { q: 'Can I track the invoices I have issued?', a: 'Yes. The NFS-e invoices are recorded and organized by customer, with a history of what has already been issued, helping you control billing and avoid duplicates.' },
      { q: 'Are all municipalities supported?', a: 'Coverage is municipal and the system checks your municipality before issuing. Some cities keep their own issuer outside the national standard; in those cases the system flags the situation during the coverage check.' },
      { q: 'How do I get started? Do I need a credit card?', a: 'Just create an account and use it free for 14 days, no credit card. You enable the invoicing module and issue the NFS-e from the customer record.' },
    ],
    finalCta: {
      title: 'Issue the NFS-e where you already work',
