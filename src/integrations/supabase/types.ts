...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      employee_face_calibration_attempts: {
        Row: {
        ...
        Relationships: [
          {
            foreignKeyName: "employee_face_calibration_attempts_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "employee_face_calibration_attempts_employee_company_fkey"
      ...
      employee_face_enrollment_tokens: {
        ...
        Relationships: [
          {
            foreignKeyName: "employee_face_enrollment_tokens_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
      ...
      inventory_count_items: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "inventory_count_items_stock_id_fkey"
            columns: ["stock_id"]
            isOneToOne: false
      ...
      inventory_count_number_counters: {
        Row: {
          company_id: string
          next_value: number
        }
        ...
        Relationships: [
          {
            foreignKeyName: "inventory_count_number_counters_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: true
            referencedRelation: "companies"
            referencedColumns: ["id"]
      ...
      inventory_count_stocks: {
        ...
        Relationships: [
          {
            foreignKeyName: "inventory_count_stocks_count_id_fkey"
            columns: ["count_id"]
            isOneToOne: false
            referencedRelation: "inventory_counts"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "inventory_count_stocks_stock_id_fkey"
            columns: ["stock_id"]
            isOneToOne: false
            referencedRelation: "stocks"
            referencedColumns: ["id"]
        ...
        Relationships: [
          {
            ...
            columns: ["category_id"]
            isOneToOne: false
            referencedRelation: "service_type_categories"
            referencedColumns: ["id"]
          },
          {
    ...
    Views: {
      ...
      inventory_count_divergences: {
        Row: {
          company_id: string | null
          count_id: string | null
          count_numero: number | null
