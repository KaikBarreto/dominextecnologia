...
export function AppSidebar() {
  ...
  // Flatten menu for collapsed view: show each top-level item icon
  // For groups, show the group icon; clicking expands sidebar
  ...
  return (
    <Sidebar collapsible="icon" className="border-r border-border bg-background">
      <SidebarContent className="flex flex-1 flex-col p-0 overflow-hidden">
        ...
        <NavLink
          to="/dashboard"
          className="h-14 flex items-center justify-center bg-white border-b border-border shrink-0 cursor-pointer"
        >
          {collapsed ? (
        ...
        <div className="flex flex-1 flex-col overflow-y-auto">
          ...
          {collapsed ? (
            ...
            <div className="p-4 pb-3 mb-1 border-b border-border">
              {profile ? (
                <div className="flex items-center gap-3">
          ...
          {/* Menu */}
          <div className={cn("flex-1 overflow-y-auto", collapsed ? "py-2 flex flex-col items-center" : "p-4 pt-2")}>
            {collapsed ? renderCollapsedMenu() : renderExpandedMenu()}
          </div>
        </div>

        {/* Footer */}
        {collapsed ? (
          <div className="border-t border-border py-2 flex justify-center shrink-0">
            <Tooltip>
              <TooltipTrigger asChild>
                <a
                  ...
                  className="h-10 w-10 flex items-center justify-center rounded-lg bg-[#25D366] text-white hover:bg-[#1da851] transition-colors"
                >
