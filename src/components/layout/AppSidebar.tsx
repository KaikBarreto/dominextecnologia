...
// Shared icon size for consistency
const ICON_SIZE = "h-[20px] w-[20px]";
  ...
  if (collapsed) {
    return (
      <Sidebar collapsible="icon" className="border-r border-border bg-background">
        <SidebarContent className="flex flex-1 flex-col items-center p-0 overflow-hidden">
          {/* Logo */}
          <NavLink
            to="/dashboard"
            className="w-full h-14 flex items-center justify-center bg-white border-b border-border shrink-0"
          >
          ...
          {/* Footer WhatsApp */}
          <div className="w-full border-t border-border py-2 flex justify-center shrink-0">
            <Tooltip>
              <TooltipTrigger asChild>
                <a
                  ...
                  className="h-10 w-10 rounded-lg flex items-center justify-center bg-[#25D366] text-white hover:bg-[#1da851] transition-colors"
                >
  ...
  return (
    <Sidebar collapsible="icon" className="border-r border-border bg-background">
      <SidebarContent className="flex flex-1 flex-col p-0 overflow-hidden">
        ...
        <NavLink
          to="/dashboard"
          className="h-14 flex items-center justify-center bg-white border-b border-border shrink-0"
        >
