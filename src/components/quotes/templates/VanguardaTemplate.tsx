          ...
          >
            <div className="flex items-start gap-3 min-w-0">
              ...
              <div className="min-w-0">
                ...
                {item.details && (
                  <p className="text-xs text-white/50 mt-1 leading-snug whitespace-pre-wrap">{item.details}</p>
                )}
      ...
      <section className="vg-page flex flex-col" style={{ background: '#000', ...colorAdjust }}>
        ...
        <div className="relative z-10 mt-auto pt-12 grid grid-cols-2 gap-6">
          <div>
            ...
            {d.clientAddressLine && <p className="text-[11px] text-white/60 mt-0.5">{d.clientAddressLine}</p>}
          </div>
