  ...
  'pt-br': {
    ...
    central: {
      ...
      filters: {
        ...
        overdue: 'Vencido',
        refunded: 'Estornado',
        searchPlaceholder: 'Buscar por cliente, telefone ou documento…',
        period: 'Período',
      },
      // Tabela / cards
      table: {
    ...
    cobrar: {
      ...
      fields: {
        ...
        valuePlaceholder: '0,00',
        dueDate: 'Vencimento',
        dueDateAccrualHint: 'Esta é a data em que o cliente deve pagar. Para o Regime de Competência, a receita entra em {date}, o dia de hoje, porque é hoje que a venda está sendo registrada.',
        description: 'Descrição',
        descriptionPlaceholder: 'Ex.: Manutenção do ar-condicionado',
        ...
        costCenterHint: 'Opcional. Vale só para esta cobrança.',
      },
    ...
    subscriptions: {
      ...
      fields: {
        ...
        category: 'Categoria',
        categoryHint: 'Opcional. Se não escolher, usa a categoria padrão da conta de recebimento.',
        costCenterHint: 'Opcional. Vale para todas as cobranças geradas por esta assinatura.',
      },
      cycles: {
        WEEKLY: 'Semanal',
        BIWEEKLY: 'Quinzenal',
  ...
  en: {
    central: {
      ...
      filters: {
        ...
        overdue: 'Overdue',
        refunded: 'Refunded',
        searchPlaceholder: 'Search by customer, phone or tax ID…',
        period: 'Period',
      },
      table: {
        customer: 'Customer',
    ...
    cobrar: {
      ...
      fields: {
        ...
        valuePlaceholder: '0.00',
        dueDate: 'Due date',
        dueDateAccrualHint: 'This is when the customer has to pay. For accrual accounting the revenue lands on {date}, today, because that is when the sale is being recorded.',
        description: 'Description',
        descriptionPlaceholder: 'E.g.: Air conditioning maintenance',
        ...
        costCenterHint: 'Optional. Applies only to this charge.',
      },
      postToFinance: {
    ...
    subscriptions: {
      ...
      fields: {
        ...
        category: 'Category',
        categoryHint: 'Optional. If left empty, uses the payment account\'s default category.',
        costCenterHint: 'Optional. Applies to every charge generated by this subscription.',
      },
      cycles: {
        WEEKLY: 'Weekly',
        BIWEEKLY: 'Biweekly',
  ...
  es: {
    central: {
      ...
      filters: {
        ...
        overdue: 'Vencido',
        refunded: 'Devuelto',
        searchPlaceholder: 'Buscar por cliente, teléfono o documento…',
        period: 'Período',
      },
      table: {
        customer: 'Cliente',
    ...
    cobrar: {
      ...
      fields: {
        ...
        valuePlaceholder: '0,00',
        dueDate: 'Vencimiento',
        dueDateAccrualHint: 'Esta es la fecha en que el cliente debe pagar. Para el Régimen de Competencia, el ingreso entra el {date}, hoy, porque es hoy que se registra la venta.',
        description: 'Descripción',
        descriptionPlaceholder: 'Ej.: Mantenimiento del aire acondicionado',
        ...
        costCenterHint: 'Opcional. Aplica solo a este cobro.',
      },
      postToFinance: {
    ...
    subscriptions: {
      ...
      fields: {
        ...
        category: 'Categoría',
        categoryHint: 'Opcional. Si no eliges una, se usa la categoría predeterminada de la cuenta de cobro.',
        costCenterHint: 'Opcional. Aplica a todos los cobros generados por esta suscripción.',
      },
      cycles: {
        WEEKLY: 'Semanal',
        BIWEEKLY: 'Quincenal',
  ...
  fr: {
    central: {
      ...
      filters: {
        ...
        overdue: 'En retard',
        refunded: 'Remboursé',
        searchPlaceholder: `Rechercher par client, téléphone ou document…`,
        period: 'Période',
      },
      table: {
        customer: 'Client',
    ...
    cobrar: {
      ...
      fields: {
        ...
        valuePlaceholder: '0,00',
        dueDate: `Échéance`,
        dueDateAccrualHint: `C'est la date à laquelle le client doit payer. Pour la comptabilité d'engagement, le produit est comptabilisé le {date}, aujourd'hui, car c'est aujourd'hui que la vente est enregistrée.`,
        description: 'Description',
        descriptionPlaceholder: 'Ex. : Entretien de la climatisation',
        ...
        costCenterHint: `Facultatif. S'applique uniquement à cette facture.`,
      },
      postToFinance: {
    ...
    subscriptions: {
      ...
      fields: {
        ...
        category: 'Catégorie',
        categoryHint: `Facultatif. Si vous n'en choisissez pas, la catégorie par défaut du compte d'encaissement est utilisée.`,
        costCenterHint: `Facultatif. S'applique à toutes les factures générées par cet abonnement.`,
      },
      cycles: {
        WEEKLY: 'Hebdomadaire',
        BIWEEKLY: 'Bimensuel',
