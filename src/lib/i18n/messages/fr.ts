...
export const frOverrides: MessagesOverride = {
  ...
  registration: {
    logoTagline: 'Maîtrisez la gestion de votre activité.',
    title: 'Inscription',
    subtitle: 'Essai gratuit de 14 jours · Sans engagement · Accès complet',
    ...
    companyNamePlaceholder: 'Ex : Mon Entreprise SARL',
    ...
    emailTaken: 'Cet e-mail est déjà utilisé. Connectez-vous ou utilisez un autre e-mail.',

    addressTitle: "Adresse de l'entreprise",
    addressOptional: '(facultatif)',
    cep: 'Code postal',
    ...
    complementPlaceholder: 'Bureau, bâtiment...',
    ...
    segmentTitle: 'Quel est votre secteur ?',
    segmentSubtitle: 'Sélectionnez pour personnaliser votre expérience',

    originTitle: 'Comment nous avez-vous connus ?',
    originSubtitle: "Sélectionnez d'où vous venez",

    accessEmailLabel: 'E-mail de connexion :',
    password: 'Mot de passe*',
    passwordPlaceholder: 'Créez votre mot de passe',
    confirmPassword: 'Confirmer le mot de passe*',
    confirmPasswordPlaceholder: 'Répétez le mot de passe',
    trialLine1: '14 jours gratuits avec accès complet',
    trialLine2: 'Sans carte bancaire, sans engagement',
    ...
    toastCepNotFoundDesc: 'Vérifiez le code et réessayez.',
    toastCepError: "Impossible de trouver le code postal",
    toastCepErrorDesc: "Saisissez l'adresse manuellement.",
    toastSuccess: 'Compte créé !',
    toastRedirectingPayment: 'Redirection vers le paiement...',
    toastRedirecting: 'Redirection...',
    toastEmailTakenTitle: 'E-mail déjà enregistré',
    toastEmailTakenDesc: 'Connectez-vous ou utilisez un autre e-mail.',
    toastError: "Erreur d'inscription",
    toastErrorFallback: "Impossible de finaliser l'inscription",
    toastSelectSegment: 'Sélectionnez votre secteur',
    toastSelectSegmentDesc: 'Indiquez le secteur de votre entreprise.',
    toastSelectOrigin: 'Sélectionnez une origine',
    toastSelectOriginDesc: 'Comment nous avez-vous connus ?',
    toastPasswordMismatch: 'Les mots de passe ne correspondent pas',
    toastPasswordWeak: 'Mot de passe faible',
    toastPasswordWeakDesc:
      'Utilisez au moins 8 caractères avec majuscules, minuscules, chiffres et/ou caractères spéciaux.',

    errorCompanyNameRequired: "Le nom de l'entreprise est obligatoire",
    errorContactNameRequired: 'Le nom est obligatoire',
  ...
  auth: {
    logoTagline: 'Maîtrisez la gestion de votre entreprise.',
    orDivider: 'ou',
    ...
    toastWelcomeTitle: 'Bienvenue !',
    toastWelcomeDesc: 'Connexion réussie',
    toastPendingPaymentTitle: 'Paiement en attente',
    toastPendingPaymentDesc: 'Finalisez le paiement pour accéder à la plateforme.',
    toastOtherSessionsDisconnected: 'Autres sessions déconnectées',
    toastLoginCanceled: 'Connexion annulée',

    errorUnexpected: "Une erreur inattendue s'est produite. Veuillez réessayer.",
    errorContinueLogin: 'Erreur lors de la poursuite de la connexion.',

    gotrueErrors: {
      invalidCredentials: 'E-mail ou mot de passe incorrect. Vérifiez vos identifiants et réessayez.',
    ...
    forgot: {
      emailStepTitle: 'Réinitialiser le mot de passe',
      emailStepSubtitle: 'Saisissez votre e-mail pour recevoir le code',
      emailLabel: 'E-mail',
      emailPlaceholder: 'vous@email.com',
      ...
      codeStepTitle: 'Saisissez le code',
      codeStepSubtitle: (length: string) => `Nous avons envoyé un code à ${length} chiffres à`,
      verifyContinue: 'CONTINUER',
      verifying: 'Vérification...',
      resendIn: (seconds: string) => `Renvoyer dans ${seconds}s`,
      resendCode: 'Renvoyer le code',
      changeEmail: "Changer d'e-mail",

      passwordStepTitle: 'Nouveau mot de passe',
      passwordStepSubtitle: "Définissez votre nouveau mot de passe d'accès",
      ...
      doneSubtitle: 'Vous pouvez maintenant vous connecter avec le nouveau mot de passe.',

      toastCodeSentTitle: 'Code envoyé',
      toastCodeSentDesc: "Vérifiez votre e-mail, cela peut prendre jusqu'à 1 minute.",
      toastErrorTitle: 'Erreur',
      toastSendCodeFallback: "Impossible d'envoyer le code",
      toastInvalidCodeTitle: 'Code invalide',
      toastInvalidCodeFallback: 'Vérifiez et réessayez',
      toastResetErrorTitle: 'Erreur lors de la réinitialisation du mot de passe',
      toastResetFallback: 'Veuillez réessayer',
    },

    reset: {
      verifying: 'Validation de votre lien de récupération…',
      invalidTitle: 'Lien invalide',
      invalidLinkMessage: 'Lien invalide. Demandez une nouvelle récupération depuis la connexion.',
      invalidCodeFallback: 'Code invalide ou expiré',
      invalidValidateFallback: 'Échec de la validation du code',
      backToLogin: 'Retour à la connexion',
      successTitle: 'Mot de passe réinitialisé !',
      successSubtitle: 'Connexion en cours…',
      readyTitle: 'Nouveau Mot de passe',
      readySubtitlePre: 'Récupération validée pour',
      newPasswordLabel: 'Nouveau Mot de passe',
      newPasswordPlaceholder: 'Créez un mot de passe sécurisé',
      confirmPasswordLabel: 'Confirmer le Mot de passe',
      confirmPasswordPlaceholder: 'Répétez le mot de passe',
      submit: 'RÉINITIALISER LE MOT DE PASSE',
      submitting: 'Réinitialisation...',
      errorPasswordMin: 'Le mot de passe doit comporter au moins 8 caractères',
      errorPasswordReqs: 'Le mot de passe ne respecte pas les exigences minimales',
      errorPasswordMismatch: 'Les mots de passe ne correspondent pas',
      resetErrorFallback: 'Erreur lors de la réinitialisation du mot de passe',
      toastResetTitle: 'Mot de passe réinitialisé',
      toastResetDesc: 'Connectez-vous avec votre nouveau mot de passe.',
      toastErrorTitle: 'Erreur',
    },
  },
