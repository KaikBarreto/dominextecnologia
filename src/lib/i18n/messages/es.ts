...
export const esOverrides: MessagesOverride = {
  ...
  // ── Registro (/cadastro) ───────────────────────────────────────────────────
  registration: {
    logoTagline: 'Domina la ejecución de tu negocio.',
    title: 'Registro',
    subtitle: 'Prueba gratis por 14 días · Sin compromiso · Acceso total',
    ...
    emailTaken: 'Este correo ya está en uso. Inicia sesión o usa otro correo.',

    addressTitle: 'Dirección de la empresa',
    ...
    complementPlaceholder: 'Piso, bloque...',
    neighborhood: 'Barrio',
    ...
    segmentTitle: '¿A qué se dedica tu negocio?',
    segmentSubtitle: 'Selecciona para personalizar tu experiencia',

    originTitle: '¿Cómo nos conociste?',
    originSubtitle: 'Selecciona de dónde vienes',

    accessEmailLabel: 'Correo de acceso:',
    password: 'Contraseña*',
    passwordPlaceholder: 'Crea tu contraseña',
    confirmPassword: 'Confirmar Contraseña*',
    confirmPasswordPlaceholder: 'Repite la contraseña',
    trialLine1: '14 días gratis con acceso total',
    trialLine2: 'Sin tarjeta de crédito, sin compromiso',
    ...
    toastCepNotFoundDesc: 'Revisa el código e inténtalo de nuevo.',
    toastCepError: 'No se pudo buscar el código postal',
    toastCepErrorDesc: 'Completa la dirección manualmente.',
    toastSuccess: '¡Cuenta creada!',
    toastRedirectingPayment: 'Redirigiendo al pago...',
    toastRedirecting: 'Redirigiendo...',
    toastEmailTakenTitle: 'Correo ya registrado',
    toastEmailTakenDesc: 'Inicia sesión o usa otro correo.',
    toastError: 'Error en el registro',
    toastErrorFallback: 'No se pudo completar el registro',
    toastSelectSegment: 'Selecciona tu sector',
    toastSelectSegmentDesc: 'Indica a qué se dedica tu empresa.',
    toastSelectOrigin: 'Selecciona un origen',
    toastSelectOriginDesc: '¿Cómo nos conociste?',
    toastPasswordMismatch: 'Las contraseñas no coinciden',
    toastPasswordWeak: 'Contraseña débil',
    toastPasswordWeakDesc:
      'Usa al menos 8 caracteres con mayúsculas, minúsculas, números y/o caracteres especiales.',

    errorCompanyNameRequired: 'El nombre de la empresa es obligatorio',
    errorContactNameRequired: 'El nombre es obligatorio',
  ...
  auth: {
    ...
    toastWelcomeTitle: '¡Bienvenido!',
    toastWelcomeDesc: 'Sesión iniciada correctamente',
    toastPendingPaymentTitle: 'Pago pendiente',
    toastPendingPaymentDesc: 'Completa el pago para acceder a la plataforma.',
    toastOtherSessionsDisconnected: 'Otras sesiones desconectadas',
    toastLoginCanceled: 'Inicio de sesión cancelado',

    errorUnexpected: 'Ocurrió un error inesperado. Inténtalo de nuevo.',
    errorContinueLogin: 'Error al continuar el inicio de sesión.',

    gotrueErrors: {
      invalidCredentials: 'Correo o contraseña incorrectos. Verifica tus credenciales e inténtalo de nuevo.',
    ...
    forgot: {
      emailStepTitle: 'Restablecer contraseña',
      emailStepSubtitle: 'Ingresa tu correo para recibir el código',
      emailLabel: 'Correo electrónico',
      emailPlaceholder: 'tu@correo.com',
      ...
      codeStepTitle: 'Ingresa el código',
      codeStepSubtitle: (length: string) => `Enviamos un código de ${length} dígitos a`,
      verifyContinue: 'CONTINUAR',
      verifying: 'Verificando...',
      resendIn: (seconds: string) => `Reenviar en ${seconds}s`,
      resendCode: 'Reenviar código',
      changeEmail: 'Cambiar correo',

      passwordStepTitle: 'Nueva contraseña',
      passwordStepSubtitle: 'Define tu nueva contraseña de acceso',
      ...
      doneSubtitle: 'Ya puedes entrar con tu nueva contraseña.',

      toastCodeSentTitle: 'Código enviado',
      toastCodeSentDesc: 'Revisa tu correo, puede tardar hasta 1 minuto.',
      toastErrorTitle: 'Error',
      toastSendCodeFallback: 'No fue posible enviar el código',
      toastInvalidCodeTitle: 'Código inválido',
      toastInvalidCodeFallback: 'Verifícalo e inténtalo de nuevo',
      toastResetErrorTitle: 'Error al restablecer la contraseña',
      toastResetFallback: 'Inténtalo de nuevo',
    },

    reset: {
      verifying: 'Validando tu enlace de recuperación…',
      invalidTitle: 'Enlace inválido',
      invalidLinkMessage: 'Enlace inválido. Solicita una nueva recuperación en el inicio de sesión.',
      invalidCodeFallback: 'Código inválido o expirado',
      invalidValidateFallback: 'No se pudo validar el código',
      backToLogin: 'Volver al inicio de sesión',
      successTitle: '¡Contraseña restablecida!',
      successSubtitle: 'Iniciando sesión…',
      readyTitle: 'Nueva Contraseña',
      readySubtitlePre: 'Recuperación validada para',
      newPasswordLabel: 'Nueva Contraseña',
      ...
      errorPasswordReqs: 'La contraseña no cumple los requisitos mínimos',
      errorPasswordMismatch: 'Las contraseñas no coinciden',
      resetErrorFallback: 'Error al restablecer la contraseña',
      toastResetTitle: 'Contraseña restablecida',
      toastResetDesc: 'Inicia sesión con tu nueva contraseña.',
      toastErrorTitle: 'Error',
    },
  },
  ...
  blog: {
    ...
    // ── Chrome de la página de post ─────────────────────────────────────────
    commentCount: (n: number) => `${n} comentario${n === 1 ? '' : 's'}`,

    commentsTitle: (n: number) => `Comentarios (${n})`,
    commentSentBanner:
      '¡Comentario enviado! Aparecerá aquí una vez aprobado por nuestro equipo.',
    commentNamePlaceholder: 'Tu nombre',
    commentContentPlaceholder: 'Deja un comentario...',
    commentDisclaimer: 'Tu comentario pasa por aprobación antes de aparecer.',
    commentSubmit: 'Comentar',
    commentEmpty: 'Aún no hay comentarios. ¡Sé el primero!',

    toastCommentSent: '¡Comentario enviado! En espera de aprobación.',
    toastCommentError: 'No se pudo enviar el comentario. Inténtalo de nuevo.',
    ...
    readsSingular: 'lectura',
    readsPlural: 'lecturas',
  },
