...
export const RETROFIT_GASES: GasSaida[] = [
  {
    ...
    opcoes: [
      ...
      {
        refrigeranteId: 'R-410A',
        gasNovo: 'R-410A',
        cor: '#EC6FAA',
        tipo: 'equipamento-novo',
        tipoLabel: 'Só em equipamento novo / projetado',
        oleo: 'POE (de fábrica no equipamento novo)',
        pressao: 'Pressões MUITO mais altas que o R-22 — incompatível com a máquina antiga.',
        cuidados: [
          'NÃO é drop-in: não usar em equipamento de R-22.',
          'Exige condensadora/evaporadora e compressor projetados para R-410A.',
          'Carregar pela fase líquida (mistura quase azeotrópica, sem glide prático).',
        ],
      },
      {
        refrigeranteId: 'R-32',
        ...
        tipoLabel: 'Só em equipamento novo / projetado',
        oleo: 'POE (de fábrica no equipamento novo)',
        pressao: 'Pressões muito mais altas que o R-22; temperatura de descarga elevada.',
        cuidados: [
          'NÃO é drop-in: só em equipamento projetado para R-32.',
      ...
      },
      {
        ...
        gasNovo: 'R-290 (Propano)',
        cor: '#EF4444',
        tipo: 'equipamento-novo',
        tipoLabel: 'Só em equipamento específico (inflamável)',
        oleo: 'Conforme equipamento projetado para R-290',
        pressao: 'Pressões na mesma ordem do R-22, mas exige projeto específico.',
        cuidados: [
          'INFLAMÁVEL (A3): NUNCA usar como drop-in em máquina de R-22.',
          'Limite de carga rígido por norma — respeitar a quantidade máxima.',
  ...
  },
  {
    ...
    opcoes: [
      ...
      },
      {
        ...
        tipoLabel: 'Só em equipamento específico (inflamável)',
        oleo: 'Conforme equipamento projetado para R-290',
        pressao: 'Usado em refrigeração comercial nova/compacta, projeto específico.',
        cuidados: [
          'INFLAMÁVEL (A3): NUNCA usar como drop-in.',
          'Limite de carga rígido por norma — respeitar a quantidade máxima.',
          'Só em equipamento projetado e certificado para propano.',
          'Cuidado com fontes de ignição na intervenção.',
        ],
